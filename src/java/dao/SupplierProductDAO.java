...
public class SupplierProductDAO extends DBContext {
    ...
    public boolean updateSupplyPrice(int supplierProductId, double supplyPrice) {
        String sql = """
            UPDATE SupplierProduct
            SET SupplyPrice = ?
            WHERE SupplierProductID = ?
    ...
    public SupplierProduct getSupplierProductById(int supplierProductId) {
        String sql = """
            SELECT sp.SupplierProductID, sp.SupplierID, sp.ProductID,
                   sp.SupplyPrice, sp.IsActive,
                   s.Name AS SupplierName,
