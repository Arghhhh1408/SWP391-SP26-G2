                        ...
                        <table style="width:100%; border-collapse: collapse;">
                            <thead>
                                <tr style="background: #f8fafc;">
                                    ...
                                    <th style="padding:15px; text-align:left;">Đơn giá</th>
                                    <th style="padding:15px; text-align:center;">Kho (Ngưỡng)</th>
                                ...
                                <c:forEach items="${products}" var="p">
                                    <tr style="border-bottom: 1px solid #f1f5f9;">
                                        ...
                                        <td style="padding:15px; text-align:center;">
                                            ...
                                            <small style="color: #94a3b8; display: block;">(${p.lowStockThreshold})</small>
                                        </td>
                                        <td style="padding:15px; text-align:center;">
        ...
        <script>
            ...
            function calculateDebt() {
                ...
                if (diff > 0) {
                    ...
                    if (debtDisp)
                        debtDisp.innerText = diff.toLocaleString('vi-VN') + " đ";
                } else {
                    ...
                    if (changeDisp)
                        changeDisp.innerText = Math.abs(diff).toLocaleString('vi-VN') + " đ";
                }
            }
