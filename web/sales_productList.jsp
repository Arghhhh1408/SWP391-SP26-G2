        ...
        <div class="layout">
            <aside class="sidebar">
                ...
                <ul class="menu">
                    ...
                    <li><a class="active" href="${pageContext.request.contextPath}/sales-products">Sản phẩm</a></li>
                ...
                <div class="content">
                    <div class="card">
                        <div style="display:flex; justify-content: space-between; margin-bottom: 20px;">
                            <form action="${pageContext.request.contextPath}/sales-products" method="get" style="display:flex; gap:10px; flex:1;">
                                <input type="text" name="keyword" value="${param.keyword}" 
                                       placeholder="Tìm theo tên hoặc SKU..." 
                                       style="padding:10px; border:1px solid #ddd; border-radius:8px; flex:0.5;">
                            ...
                            <tbody>
                                <c:forEach items="${sale_productList}" var="p">
                                    <tr>
                                        ...
                                        <td>${p.unit}</td>
                                        <td>
                                            <a href="SalesProductDetail?id=${p.id}" class="btn btn-info">Xem chi tiết</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
