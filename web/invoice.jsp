...
<html>
    ...
    <body>
        ...
        <div class="no-print">
            ...
            <a class="link" href="${pageContext.request.contextPath}/pos"
               onclick="return confirm('Bạn chưa bấm Hoàn tất. Quay lại thì đơn chưa được ghi nhận/trừ kho. Tiếp tục?')">
                Quay lại POS
            </a>
        </div>
