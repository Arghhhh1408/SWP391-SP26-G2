...
<aside class="sidebar">
    ...
    <nav>
        ...
        <a href="staff_dashboard?tab=warranty" class="${tab == 'warranty' ? 'active' : ''}">Yêu cầu bảo hành</a>
        <a href="staff_dashboard?tab=returns" class="${tab == 'returns' ? 'active' : ''}">Yêu cầu trả hàng</a>
        <a href="staff_dashboard?tab=products" class="${tab == 'products' ? 'active' : ''}">Danh sách sản phẩm</a>
    </nav>
    ...
    <div class="content">
        <c:choose>
            <c:when test="${tab == 'returns'}">
                <div class="box">
                    <div class="box-header"><h3>Danh sách yêu cầu trả hành</h3></div>
                    <div class="box-body">
                        <table>
                            <tr>
                                <th>Ma yeu cau</th>
                            ...
                            <c:if test="${empty returns}">
                                <tr><td colspan="7">Chưa có yêu cầu bảo hành.</td></tr>
                            </c:if>
                        </table>
                    </div>
                </div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <a href="staff_dashboard?tab=products">Hủy</a>
                                            </td>
                                        </tr>
                                    </table>
                                </form>
            ...
            <c:otherwise>
                <div class="box">
                    <div class="box-header"><h3>Danh sách yêu cầu bảo hành</h3></div>
                    <div class="box-body">
                        <table>
                            <tr>
                                <th>Ma yeu cau</th>
