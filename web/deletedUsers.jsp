                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.list}" var="u">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${u.roleID == 0}"><span
                                                                class="role-badge role-admin">Admin</span></c:when>
                                                        <c:when test="${u.roleID == 1}"><span
                                                                class="role-badge role-staff">Staff</span></c:when>
                                                        <c:when test="${u.roleID == 2}"><span
                                                                class="role-badge role-manager">Manager</span></c:when>
                                                        <c:when test="${u.roleID == 3}"><span
                                                                class="role-badge role-sales">Sales</span></c:when>
                                                    </c:choose>
                                                </td>
                                                <td style="font-size: 13px; color: var(--text-muted);">${u.email}</td>
                                                <td style="font-size: 13px;">${u.phone}</td>
                                                <td>
                                                    <a href="restoreUser?id=${u.userID}"
                                                        class="action-link restore-link"
