            ...
            <aside class="sidebar">
                ...
                <nav>
                    ...
                    <a href="sales_dashboard?tab=warranty-create"
                        class="${tab == 'warranty-create' ? 'active' : ''}">Tạo yêu cầu bảo hành</a>
                    <a href="sales_dashboard?tab=return-create" class="${tab == 'return-create' ? 'active' : ''}">Tạo
                        yêu cầu trả hàng</a>
                    <a href="sales_dashboard?tab=warranty-lookup"
                        class="${tab == 'warranty-lookup' ? 'active' : ''}">Tra cứu bảo hành</a>
                    <a href="sales_dashboard?tab=return-lookup" class="${tab == 'return-lookup' ? 'active' : ''}">Tra
                        cứu trả hàng</a>
                    <a href="sales_dashboard?tab=products" class="${tab == 'products' ? 'active' : ''}">Xem tất cả sản
                        phẩm</a>
                </nav>
